...
<body>
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3 class="text-center">HOPIA DE TRES INVENTORY</h3>
            </div>
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="#">FINANCIAL PERFORMANCES</a>
                </li>
                <li>
                    <a href="#">INCOMING DELIVERY</a>
                </li>
                <li>
                    <a href="#">RECEIVED DELIVERY</a>
                </li>
            </ul>
        </nav>
    ...
    <div id="content">
      ...
      <!-- Site footer -->  
      <footer class="site-footer" style="margin-left:264px">
