...
<body>
        ...
        <div class="login">
            <div class="wrap">
                ...
                <!-- TERMS -->
                <div class="terms">
                    <h2>Hopia De Tres Terms of Service</h2>
                    <p class="small">Last modified: April 29,2021</p>
                    <h3>Welcome to Hopia De Tres</h3>
                ...
                <div class="content">
                    ...
                    <div id="slideshow">
                        <div class="one">
                            ...
                            <p>Your Honesty is our best asset</p>
                        </div>
                        <div class="two">
                            <h2><span>UPDATES</span></h2>
                            <p>Keep it updated and you're good to go</p>
                        </div>
                        <div class="three">
                            <h2><span>PRECISE</span></h2>
                            <p>Provide datas and information completely</p>
                        </div>
                        <div class="four">
                            <h2><span>THANK YOU</span></h2>
                            <p>Your service is our happiness!!!</p>
                        </div>
                    </div>
                </div>
                <!-- LOGIN FORM -->
...
$(function() {
    $('.agree, #toggle-terms, .log-in').on('click', function(event) {
        event.preventDefault();
        var terms = $('.terms'),
            recovery = $('.recovery'),
            close = $('#toggle-terms'),
